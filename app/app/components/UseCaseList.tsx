                  ...
                  {uc.sources.length > 0 && (
                    <span className="flex items-center gap-2">
                      {uc.sources.includes("passport") && (
                        <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded border border-ink-border bg-ink-surface/60 text-ink-muted">
                          <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            <rect x="2" y="3" width="20" height="18" rx="2" />
                            <circle cx="12" cy="11" r="3" />
                            <path d="M6 21v-1a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v1" />
                          </svg>
                          <span className="font-mono text-[11px] uppercase tracking-wider">passport</span>
                        </span>
                      )}
